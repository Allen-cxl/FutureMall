...
public class PreviewActivity extends BaseImagePickerToolBarActivity implements View.OnClickListener,ImagePreviewFragment.OnImageSingleTapClickListener,ImagePreviewFragment.OnImagePageSelectedListener,AndroidImagePicker.OnImageSelectedListener {
    ...
    public void onImageSingleTap(MotionEvent e) {
        View topBar = findViewById(R.id.super_toolbar);
