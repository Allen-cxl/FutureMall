...
public class CropActivity extends BaseImagePickerToolBarActivity implements View.OnClickListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            finish();
            AndroidImagePicker.getInstance().notifyImageCropComplete(bmp, 0,this);
            return true;
        }
