...
public class ImagesGridFragment extends Fragment implements OnImagesLoadedListener,AndroidImagePicker.OnImageSelectedListener,AndroidImagePicker.OnImageCropCompleteListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new ImageGridAdapter(mContext,new ArrayList<ImageItem>());
    ...
    public void onImageSelected(int position, ImageItem item, int selectedItemsCount, int maxSelectLimit) {
        mAdapter.refreshData(androidImagePicker.getImageItemsOfCurrentImageSet());
            ...
            if(itemViewType == ITEM_TYPE_CAMERA){
                ...
                convertView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AndPermission.with(ImagesGridFragment.this)
                    ...
                    public void onClick(View v) {
                        if(androidImagePicker.getSelectImageCount() > androidImagePicker.getSelectLimit()){
                            if(holder.cbSelected.isChecked()){
                                ...
                                String toast = getResources().getString(R.string.you_have_a_select_limit, String.valueOf(androidImagePicker.getSelectLimit()));
                ...
                mImagePresenter.onPresentImage(holder.ivPic, getItem(position).path, imageGridSize, true);
    ...
    class ImageSetAdapter extends BaseAdapter {
        ...
        class ViewHolder{
            ...
            void bindData(ImageSet data) {
                ...
                mImagePresenter.onPresentImage(cover, data.cover.path, imageGridSize, true);
            }
    ...
    RationaleListener rationale = new RationaleListener() {
        ...
        public void showRequestPermissionRationale(int requestCode, final Rationale rationale) {
            new AlertDialog.Builder(getActivity())
                    .setTitle("友好提醒")
                    .setMessage("没有读取文件权限无法选择照片，请把权限赐予我吧！")
    ...
    public void doFail(){
        Toast.makeText(getActivity(), getString(R.string.camera_permission_fail), Toast.LENGTH_SHORT).show();
    }
